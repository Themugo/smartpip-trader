...
echo "============================================"
echo ""
echo "📍 Deployment: Vercel (smartpip-trader project)"
echo ""
...
if [ -z "$VERCEL_PROJECT_ID" ]; then
    ...
    echo "2. Select the smartpip-trader project"
...
echo "   Production: https://smartpip-trader.vercel.app"
echo "   Staging: https://smartpip-trader-staging.vercel.app"
